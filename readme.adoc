# Multi-Agent Oriented Programming Exercises
:toc: right
...
This guide contains practical material for the tutorial _Multi-Agent Oriented Programming_ at https://ai4industry2023.sciencesconf.org[3rd Summer School on AI Technologies for Trust, Interoperability, Autonomy and Resilience in Industry 4.0].
